...
def run_train():
    ...
    # args = parser.parse_args(['--model_dir', 'retina_fpn_spd'])
    args = parser.parse_args(['--model_dir', 'atss_fpn_vpd_s2'])
    # args = parser.parse_args(['--model_dir', 'freeanchor_fpn_vpd'])
    args.resume_weights = 13
